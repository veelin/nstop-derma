...
type MyProps = {
    ...
    flowKey: string | null,
    showDataDrawer : Function,
    saveFlow: Function,
    deployFlow: Function
}


export default class ToolBar extends React.Component<MyProps> {

    flowName:any;
    render(): React.ReactNode {
        return <div className='node-red-toolbar'>
            <div className="tool-bar">
                <div className="flow-name">{this.props.flowName} <span>({this.props.flowKey})</span></div>
                <div className="tool-icons">
                    <Tooltip title="查看流程图数据">
                        <svg onClick = {()=>this.props.showDataDrawer()} className="tool-bar-icon download-icon" viewBox="0 0 1024 1024" width="24" height="24">
                    ...
                    <Tooltip title="发布流程">
                        <svg onClick = {()=>this.props.deployFlow()} className="tool-bar-icon download-icon" viewBox="0 0 1024 1024" width="24" height="24">
                    ...
                    <Tooltip title="保存到服务端">
                        <svg onClick = {()=>this.props.saveFlow()} className="tool-bar-icon save-icon" viewBox="0 0 1024 1024" width="30" height="30">
